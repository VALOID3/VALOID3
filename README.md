...
Desarrollador de Software Junior con formación en Multimedia y Animación Digital (UANL) de la Facultad de Ciencias Fisico Matematicas, especializado en Front-End, backend y bases de datos SQL.  
...
🎓 Estudiante de LMAD en UANL | 📍 Monterrey, Nuevo León | 🧠 Apasionado por el diseño UX/UI, bases de datos y aplicaciones web interactivas
...
- **Calculadora Web**: JavaScript Vanilla [Calculadora](https://github.com/VALOID3/Project-Calculadora.git)

🛠️ Tecnologías que uso:
`C# /.NET` `JavaScript` `React.js` `SQL Server/MySQL ` `PHP` `HTML/CSS` `Node.js` `Figma` `GitHub` `Suit Adobe` `Bootstrap`
